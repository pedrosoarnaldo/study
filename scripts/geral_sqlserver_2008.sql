...
-- 10.50.1817		RTM CU14 --->			10.50.2817  SP1 CU7       
...
-- Get information on location, time and size of any memory dumps from SQL Server (SQL Server 2008 R2 SP1 or greater)  (Query 12)
...
-- Top Cached SPs By Execution Count (SQL 2008) (SQL 2008 R2 SP1 only) (Query 35)
...
-- Top Cached SPs By Avg Elapsed Time with execution time variability   (Query 37)
