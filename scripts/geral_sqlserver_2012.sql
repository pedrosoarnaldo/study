...
-- Recovery model, log reuse wait description, log file size, log usage size  (Query 17) 
...
-- Get VLF count for transaction log for the current database,  (Query 36)
...
-- Top cached queries by Execution Count (SQL Server 2012)  (Query 37)
...
-- Top Cached SPs By Execution Count (SQL Server 2012)  (Query 38)
...
-- Top Cached SPs By Avg Elapsed Time (SQL Server 2012)  (Query 39)
...
-- Top Cached SPs By Avg Elapsed Time with execution time variability (SQL Server 2012)  (Query 40)
...
-- Top Cached SPs By Total Worker time (SQL Server 2012). Worker time relates to CPU cost  (Query 41)
...
-- Top Cached SPs By Total Logical Reads (SQL Server 2012). Logical reads relate to memory pressure  (Query 42)
...
-- Top Cached SPs By Total Physical Reads (SQL Server 2012). Physical reads relate to disk I/O pressure  (Query 43)
...
-- Top Cached SPs By Total Logical Writes (SQL Server 2012)  (Query 44)
...
-- Lists the top statements by average input/output usage for the current database  (Query 45)
...
-- Possible Bad NC Indexes (writes > reads)  (Query 46)
...
-- Missing Indexes for current database by Index Advantage  (Query 47)
...
-- Find missing index warnings for cached plans in the current database  (Query 48)
...
-- Get Table names, row counts, and compression status for clustered index or heap  (Query 50)
...
-- When were Statistics last updated on all indexes?  (Query 51)
...
-- Get fragmentation info for all indexes above a certain size in the current database  (Query 52) 
...
--- Index Read/Write stats (all tables in current DB) ordered by Reads  (Query 53)
...
--- Index Read/Write stats (all tables in current DB) ordered by Writes  (Query 54)
SELECT OBJECT_NAME(s.[object_id]) AS [ObjectName], i.name AS [IndexName], i.index_id,
